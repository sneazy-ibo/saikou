...
class BookDialog(private val novelName:String, private val novel: ShowResponse, private val source:Int) : BottomSheetDialogFragment() {
    ...
    companion object {
        fun newInstance(novelName:String, novel:ShowResponse, source: Int) = BookDialog(novelName, novel, source)
    }
}